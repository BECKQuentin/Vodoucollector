...
class MediaController extends AbstractController
{
     ...
     *
     */
    public function mediaIndex(Objects $objects, Request $request, UploadService $uploadService, ImagesRepository $imagesRepository): Response
    {
     ...
     *
     */
    public function mediaDelete(Images $images, Request $request, UploadService $uploadService) {
