...
class YoutubeController extends AbstractController
{
     ...
     *
     */
    public function youtubeIndex(Objects $objects, Request $request, YoutubeRepository $youtubeRepository): Response
    {
        $youtube = new Youtube();
     ...
     *
     */
    public function youtubeDelete(Youtube $youtube, Request $request, UploadService $uploadService) {
